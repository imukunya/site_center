...
public class DatabaseRule extends ExternalResource {
    ...
    protected void before() {
        DB.sql2o = new Sql2o("jdbc:postgresql://localhost:5432/site_maintenance_test", null, null);  //Those with linux or windows use two strings for username and password
    }
